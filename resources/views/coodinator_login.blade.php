...
<html lang="en">
  <head>
    ...
    <title>CPM - Coordinator Login</title>
...
<div class="container">
  ...
  <a class="dropdown-toggle" type="button" data-toggle="dropdown" data-hover="dropdown">
   Coodinator <span class="caret"></span>
  </a>
...
<div class="dropdown">
  <button class="dropbtn">Coordinator <i class="fa fa-caret-down"></i></button>
...
<form class="container pl-5 pr-5" action="{{url('coodinator_login')}}" method="POST" enctype="multipart/form-data">
  @csrf
