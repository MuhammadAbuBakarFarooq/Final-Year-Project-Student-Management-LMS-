...
<html lang="en">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    <title>CPM - Supervisors Ideas</title>
...
<div style="display: inline;">
 ...
 <h2>Supervisor Ideas List</h2><br>
 </div>
    <div class="row">
      <div class="col-6">
  ...
  <tbody id="myTable">
    ...
    <tr>
      ...
      <td><a href="{{ route('idea.delete/', $row->id) }}" onclick="return  confirm('do you want to delete this idea')" name="delete" class="mr-2

        "><i class="fa fa-trash-alt" style="color:#ff2828"></i></a>
        
       
       <a href="{{ route('idea.edit/', $row->id) }}" name="edit" class="


        "><i class="far fa-edit" style="color:#17a2b8"></i></a></td>
        <?php }else echo "<td></td>" ?>
       <?php } ?>
