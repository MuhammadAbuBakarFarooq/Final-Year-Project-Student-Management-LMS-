...
<div class="row">
  ...
  <div class="col-lg-6 col-sm-8">
    ...
    <div class="container mt-3">
        @if($requested == 0)
                <div class="alert alert-danger">The Idea is already taken</div>
        @endif
    </div>
...
<div class="container mt-3">
    ...
    <div class="container mt-3">
        @if(Session::has('idea_taken'))
                <div class="alert alert-success"> {{Session::pull('idea_taken')}}</div>
        @endif
    </div>
<div class="container mt-3">
        @if(Session::has('msg2'))
...
<div class="container">
 ...
 <?php if (Session::get('key') == 'supervisor' && Session::get('user_id') == $row->supervisor_id ) {
        # code...
       ?>
  <a href="{{ route('idea.edit/', $row->id) }}" name="edit" style="float: right;" class="btn btn-light">Edit</a> <?php } ?>
 ...
 <?php if (Session::get('key') == 'student' && Session::get('student_type') == 1 ) {
       ...
       @if($requested == 1)
    <?php if ($pidea == 1): ?>
  <a href="{{ route('request.supervisor.idea/', $row->id) }}" name="request" style="float: right;" class="btn btn-success
