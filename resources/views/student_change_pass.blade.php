...
<html lang="en">
  <head>
    ...
    <title>CPM - Student Change Password</title>
...
<div class="container">
  <div class="mr-auto main">
    ...
    <h3>STUDENT </h3><label> Change Password</label>
    </div>
<form action="{{url('change_pass_student')}}" method="POST" enctype="multipart/form-data" class="ml-5 mr-5">
  @csrf
 <input type="hidden" name="id" value="{{Session::get('student_id')}}">
  ...
  <div class="form-group ">
    <div class="">
      ...
      <button class="btn btn-light" style="background-color: #fd7e14;"><a href="{{url('student_dashboard')}}" style="color: white; text-decoration: none;">Cancle</a></button>
    </div>
  </div>
</form>
  </div>
