...
<div class="main" style="width:110vh !important; margin-left: -5%">
  ...
  <div class="jumbotron ml-5 mr-5 mt-5 pt-2" style="margin-top: 5% !important">
    ...
    <h3 style="font-size: 20px; font-weight: bolder;">Group Members:</h3>
    <?php if ($group_id != 0){ ?>
  ...
  <thead class="tdark">
    ...
    <div class="container pt-3 mb-2">
        <h3 style="font-size: 20px; font-weight: bolder;">Superisor:</h3>
    <label style="font-size: 20px">{{$supervisor_name}}</label><hr>
  </div>
 ...
 @endforeach
    ...
    <?php }else echo "<tabe>No Project yet</tabel>";}else{
      echo "<tabe>Not in a group</tabel>";
    } ?>
