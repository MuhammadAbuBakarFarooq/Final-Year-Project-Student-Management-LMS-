...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <a class="ddm" href="{{url('/')}}">Coordinator</a><br>
    <!-- <a class="ddm" href="{{url('faculty_login_page')}}">Supervisor</a><br> -->
    <a class="ddm" href="{{url('faculty_login_page')}}">Faculty</a>
  </div>
</div>
    </div>
<form class="container pl-5 pr-5" action="{{url('student_login')}}" method="POST" enctype="multipart/form-data">
  @csrf
  ...
  @endif
   ...
   <div class="form-group ">
    <label for="Password" class="inplabel"><a href="{{url('forgot/password/student')}}">Forgot Password.?</a></label> 
