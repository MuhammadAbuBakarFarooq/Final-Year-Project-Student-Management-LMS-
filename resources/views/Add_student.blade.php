...
<div class="container">
  <div class="mr-auto main">
    ...
    <form class="mainform" action="{{url('add_new_student')}}" method="POST" enctype="multipart/form-data">
  @csrf
  ...
  <div class="form-group ">
    ...
    <p class="invalid-feedback" style="color: red; display:none;" id="em"> {{$errors->first('email')}} </p>
       @if($errors->any())
  ...
  <div class="form-group ">
    <label for="cgpa" class="inplabel">CGPA</label> 
      <input id="cgpa" name="cgpa" type="number" step="0.01" class="form-control {{ ($errors->any() && $errors->first('cgpa')) ? 'is-invalid' : '' }}" >
 @if($errors->any())
