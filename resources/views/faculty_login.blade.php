...
<html lang="en">
  <head>
    ...
    <title>CPM - Faculty Member Login</title>
...
<div class="container mt-3">
        ...
        @endif
         @if(Session::has('msg_succ'))
                <div class="alert alert-success"> {{Session::pull('msg_succ')}}</div>
        @endif
    </div>
<div class="row mt-5">
...
<div class="container">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a class="ddm" href="{{url('faculty_login_page')}}">Supervisor</a></li>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <!-- <a class="ddm" href="{{url('faculty_login_page')}}">Supervisor</a><br> -->
    <a class="ddm" href="{{url('/')}}">Coordinator</a>
  </div>
</div>
    </div>
<form class="container pl-5 pr-5" action="{{url('faculty_login')}}" method="POST" enctype="multipart/form-data">
  @csrf
  ...
  <div class="form-group ">
    <label for="Password" class="inplabel"><a href="{{url('forgot/password/faculty')}}">Forgot Password.?</a></label> 
