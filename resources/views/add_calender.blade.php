...
<div class="container">
  ...
  <div class="mr-auto main">
    ...
    <form class="container pl-5 pr-5" action="{{url('coodinator/add_event')}}" method="POST" enctype="multipart/form-data">
  @csrf
  ...
  @endif
   ...
   <div class="form-group ">
      ...
      <input id="text" name="week" type="week" class="form-control {{ ($errors->any() && $errors->first('week')) ? 'is-invalid' : '' }}">
       @if($errors->any())  
 ...
 <!--  <div class="form-group ">
      ...
      <input id="start_date" name="start_date" type="date" class="form-control {{ ($errors->any() && $errors->first('start_date')) ? 'is-invalid' : '' }}">
       @if($errors->any())  
 ...
 <!--  <div class="form-group ">
      ...
      <input id="end_date" name="end_date" type="date" class="form-control {{ ($errors->any() && $errors->first('end_date')) ? 'is-invalid' : '' }}">
       @if($errors->any())  
  ...
  <div class="form-group ">
    <div class="">
      <button name="submit" type="submit" class="btn btn-light">Add Event</button>
