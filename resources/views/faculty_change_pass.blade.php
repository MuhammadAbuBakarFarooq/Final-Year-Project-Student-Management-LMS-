...
<html lang="en">
  <head>
    ...
    <title>CPM - Faculty Change Password</title>
...
<div class="container">
  <div class="mr-auto main">
    ...
    <h3>Faculty </h3><label> Change Password</label>
    </div>
<form action="{{url('change_pass_faculty')}}" method="POST" enctype="multipart/form-data" class="ml-5 mr-5">
  @csrf
 <input type="hidden" name="id" value="{{Session::get('id')}}">
  ...
  <div class="form-group ">
    <div class="">
      ...
      <button class="btn btn-light" style="background-color: #fd7e14;">

        <a href="{{url('supervisor_dashboard')}}" style="color: white; text-decoration: none;">Cancle</a>
      </button>

       <?php }elseif (Session::get('key') == 'faculty') { ?>
  
    <button class="btn btn-light" style="background-color: #fd7e14;">          
        
        <a href="{{url('faculty_dashboard')}}" style="color: white; text-decoration: none;">Cancle</a>
