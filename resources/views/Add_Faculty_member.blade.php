...
<html lang="en">
  <head>
    ...
    <title>CPM - Add Faculty member</title>
...
<div class="container">
 ...
 <form class="mainform" action="{{url('add_new_faculty')}}" method="POST" enctype="multipart/form-data">
  @csrf
  ...
  <div class="form-check">
    <input type="checkbox" class="form-check-input" name="is_supervisor" id="materialUnchecked" style="margin-left: -5%;">
    <label class="form-check-label" for="materialUnchecked">Make Supervisor</label>
</div><br>
  <div class="form-group ">
    <div class="">
    ...
    <script type="text/javascript">
      $('#email').on('keyup',function(){
        ...
        $.ajax({
          ...
          url: "{{url('validation_check_email_faculty')}}",
          cache: false,
          success: function(html){
            console.log(html);
            if (html != "") {
